          ...
          <div className="flex flex-col gap-3 items-center lg:items-start mt-4 lg:mt-0">
            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              <p className="font-medium text-center lg:text-left">
                ...
                <br />
                <span className="m-auto"> Siliguri 734006</span>
              </p>
            </div>
          </div>

          <div className="flex flex-col lg:flex-row items-center mt-2 lg:mt-10">
            <div className="flex items-center">
              ...
              <BiSolidStarHalf
                ...
                className="text-xl text-white opacity-60"
              />
              <span className="mt-1 font-medium">4.9</span>
            </div>
            <p className="font-medium lg:ml-4">181 reviews</p>
          </div>

          <div className="flex flex-col gap-4 justify-center items-center mt-4 lg:mt-0">
            <h3 className="text-2xl font-bold drop-shadow-md">Connect</h3>
            <div className="flex items-center gap-4">
              <NavLink to="#">
                <AiOutlineInstagram className="text-4xl text-white opacity-60" />
              </NavLink>
              <NavLink to="#">
                <BsFacebook className="text-3xl text-white opacity-60" />
              </NavLink>
            </div>
          </div>
          <div className="w-11/12 border-2  opacity-40 m-auto mt-8"></div>
        </div>
        <div className="copyright text-center font-semibold mt-6">
